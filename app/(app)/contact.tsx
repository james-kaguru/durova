  ...
  return (
    <section id="contact" className="py-24 border-b">
      <div className="custom-container">
        <h2 className="text-primary scroll-m-20 pb-2  text-3xl font-semibold tracking-tight first:mt-0">Get in Touch</h2>

        <div className="grid lg:grid-cols-2 gap-16">
          <div className="space-y-6">
            <p className="max-w-[500px] leading-7 text-muted-foreground">
              Have questions or want to partner with us? We&apos;re here to help and coordinate for a safer Kenya.
            </p>
          ...
          <form className="space-y-6">
            ...
            <Button size="lg" className="w-full h-10">Send Message</Button>
          </form>
        </div>
      </div>
    </section>
